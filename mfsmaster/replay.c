...
uint8_t do_access(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(inode,ptr);
        EAT(ptr,lv,')');
        return slave_fs_access(ts,inode);
}
...
uint8_t do_append(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,')');
        return slave_fs_append(ts,inode,inode_src);
}
...
uint8_t do_aquire(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(cuid,ptr);
        EAT(ptr,lv,')');
        return slave_fs_aquire(inode,cuid);
}
...
uint8_t do_attr(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(mtime,ptr);
        EAT(ptr,lv,')');
        return slave_fs_attr(ts,inode,mode,uid,gid,atime,mtime);
}
...
uint8_t do_create(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(inode,ptr);
        return slave_fs_create(ts,parent,strlen((char*)name),name,type,mode,uid,gid,rdev,inode);
}
...
uint8_t do_emptytrash(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        return slave_fs_emptytrash(ts,freeinodes,reservedinodes);
}
...
uint8_t do_emptyreserved(uint64_t lv,uint32_t ts,char* ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(freeinodes,ptr);
        return slave_fs_emptyreserved(ts,freeinodes);
}
...
uint8_t do_freeinodes(uint64_t lv,uint32_t ts,char* ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(freeinodes,ptr);
        return slave_fs_freeinodes(ts,freeinodes);
}
...
uint8_t do_incversion(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU64(chunkid,ptr);
        EAT(ptr,lv,')');
        return slave_fs_incversion(chunkid);
}
...
uint8_t do_link(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETNAME(name,ptr,lv,')');
        EAT(ptr,lv,')');
        return slave_fs_link(ts,inode,parent,strlen((char*)name),name);
}
...
uint8_t do_length(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU64(length,ptr);
        EAT(ptr,lv,')');
        return slave_fs_length(ts,inode,length);
}
...
uint8_t do_move(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(inode,ptr);
        return slave_fs_move(ts,parent_src,strlen((char*)name_src),name_src,parent_dst,strlen((char*)name_dst),name_dst,inode);
}
...
uint8_t do_purge(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(inode,ptr);
        EAT(ptr,lv,')');
        return slave_fs_purge(ts,inode);
}
...
uint8_t do_release(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(cuid,ptr);
        EAT(ptr,lv,')');
        return slave_fs_release(inode,cuid);
}
...
uint8_t do_repair(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(version,ptr);
        return slave_fs_repair(ts,inode,indx,version);
}
...
uint8_t do_seteattr(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,',');
        GETU32(npi,ptr);
        return slave_fs_seteattr(ts,inode,uid,eattr,smode,ci,nci,npi);
}
...
uint8_t do_setgoal(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,',');
        GETU32(npi,ptr);
        return slave_fs_setgoal(ts,inode,uid,goal,smode,ci,nci,npi);
}
...
uint8_t do_setpath(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,')');
        return slave_fs_setpath(inode,path);
}
...
uint8_t do_settrashtime(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,',');
        GETU32(npi,ptr);
        return slave_fs_settrashtime(ts,inode,uid,trashtime,smode,ci,nci,npi);
}
...
uint8_t do_snapshot(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,')');
        return slave_fs_snapshot(ts,inode,parent,strlen((char*)name),name,canoverwrite);
}
...
uint8_t do_symlink(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(inode,ptr);
        return slave_fs_symlink(ts,parent,strlen((char*)name),name,path,uid,gid,inode);
}
...
uint8_t do_undel(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU32(inode,ptr);
        EAT(ptr,lv,')');
        return slave_fs_undel(ts,inode);
}
...
uint8_t do_unlink(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU32(inode,ptr);
        return slave_fs_unlink(ts,parent,strlen((char*)name),name,inode);
}
...
uint8_t do_unlock(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        GETU64(chunkid,ptr);
        EAT(ptr,lv,')');
        return slave_fs_unlock(chunkid);
}
...
uint8_t do_trunc(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU64(chunkid,ptr);
        return slave_fs_trunc(ts,inode,indx,chunkid);
}
...
uint8_t do_write(uint64_t lv,uint32_t ts,char *ptr) {
        ...
        EAT(ptr,lv,':');
        GETU64(chunkid,ptr);
        return slave_fs_write(ts,inode,indx,opflag,chunkid);
}
