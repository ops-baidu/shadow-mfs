...
// -
#define MLTOMA_ACK_CHANGELOG 65 
// flag:8
#define MLTOMA_CHANGELOG_READY 66
// -
#define MATOML_SYNC_THREAD 67
// flag:8
#define MATOML_CHANGELOG_ROTATE 68
// log_count:8 version:64 size:32 logstr


// SLAVE <-> MASTER

#define SLATOMA_REGISTER 75
// rver:8
// 	rver==1:
// 		version:32 timeout:16
#define MATOSLA_METACHANGES_LOG 76
// 0xFF:8 version:64 logdata:string ( N*[ char:8 ] ) = LOG_DATA
// 0x55:8 = LOG_ROTATE
#define SLATOMA_DOWNLOAD_START 77
// -
#define MATOSLA_DOWNLOAD_START 78
// status:8
// length:64
#define SLATOMA_DOWNLOAD_DATA 79
// offset:64 leng:32
#define MATOSLA_DOWNLOAD_DATA 80
// offset:64 leng:32 crc:32 data:lengB
#define SLATOMA_DOWNLOAD_END 81
// -
#define SLATOMA_ACK_CHANGELOG 82 
// flag:8
#define SLATOMA_CHANGELOG_READY 83
// -
#define MATOSLA_SYNC_THREAD 84
// flag:8
#define MATOSLA_CHANGELOG_ROTATE 85
// log_count:8 version:64 size:32 logstr
